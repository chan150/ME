...
class RedunRowPartitioner(r: Int, n: Int) extends Partitioner {
  ...
  override def equals(obj: scala.Any): Boolean = {
    obj.isInstanceOf[RedunRowPartitioner] && numPartitions == obj.asInstanceOf[RedunRowPartitioner].numPartitions
  }
